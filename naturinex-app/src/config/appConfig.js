...
// This file conditionally imports based on the platform

let getConfig;

// Check if we're in a web environment
if (typeof window !== 'undefined' && !window.expo) {
  // Web environment - use web config
  getConfig = require('./appConfig.web.js').default;
} else {
  // Mobile environment - use Expo constants
