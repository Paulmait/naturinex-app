...
export const PRICING_TIERS = {
  ...
  PREMIUM: {
    ...
    limits: {
      ...
      dailyScans: 10,
      maxDevices: 3,
      message: '25 scans per month, 1 year data retention'
    },
    description: 'Unlock the full Naturinex experience',
    benefits: [
      '25 scans per month',
      'Full scan history (1 year)',
      'Advanced AI analysis (5+ alternatives)',
      'Export PDF reports',
  ...
  // Keep PLUS as alias for backward compatibility (same as PREMIUM)
  PLUS: {
    id: 'premium',
    name: 'Naturinex Premium',
    price: { monthly: 9.99, yearly: 99.99 },
    stripePriceIds: { monthly: 'price_1RpEeKIwUuNq64Np0VUrD3jm', yearly: 'price_1RpEeKIwUuNq64Np0VUrD3jm' },
    features: { scansPerMonth: 25, scansPerDay: 10, saveHistory: true, aiInsights: true, naturalAlternatives: 5, exportReports: true, maxDevices: 3, screenshotAllowed: true },
    limits: { monthlyScans: 25, dailyScans: 10, maxDevices: 3 },
    benefits: ['25 scans per month', 'Full scan history', 'Advanced AI analysis', 'Export PDF reports', 'Up to 3 devices'],
    trialDays: 7,
    popular: true,
  },

  // Keep PRO as alias (same as PREMIUM)
  PRO: {
    id: 'premium',
    name: 'Naturinex Premium',
    price: { monthly: 9.99, yearly: 99.99 },
