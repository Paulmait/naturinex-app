...
function initializeFirebase() {
  ...
  try {
    ...
    // Development: Use client configuration (limited functionality)
      ...
      console.log('⚠️  Firebase Admin initialized with limited functionality (no service account)');
      console.log('   To enable full functionality, add FIREBASE_PRIVATE_KEY and FIREBASE_CLIENT_EMAIL to .env');
    }
