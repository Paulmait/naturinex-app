...
export const generateDownloadReport = (suggestions, medicationName, userTier, user = null) => {
  ...
  const filename = `MediScan_${sanitizedMedName}_${timestamp}.txt`;
...
export const generateEmailContent = (suggestions, medicationName, userTier, user = null) => {
  ...
  const subject = `MediScan ${tierName} Analysis: ${medicationName}`;
...
export const getBrandingWatermark = (userTier) => {
  const watermarks = {
    free: '🏷️ Generated by MediScan Free - Upgrade for more features!',
    basic: '📱 Powered by MediScan Basic',
    premium: '💎 MediScan Premium Analysis',
    professional: '🏆 MediScan Professional Report'
  };
